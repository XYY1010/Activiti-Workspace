...
<body>
<form method="post" action="process-startExpenseAccount.action">
    <div id="main">
        ...
        <div id="tagContent0" class="sort_content">
            ...
            <div class="currency_area hue9">
                <div class="the_content">
                    <input name="expenseAccountForm.userId" type="hidden" value="${sessionScope.user.id}"/>
                    <input name="expenseAccountForm.userName" type="hidden" value="${sessionScope.user.lastName}"/>
                    <table class="tableHue2" width="100%" border="1" bordercolor="#dddddd" cellspacing="0" cellpadding="0">
                        <tbody>
                        <tr>
                            <td width="15%" class="title1">发生日期：</td>
                            <td class="left"><input name="expenseAccountForm.date" id="date" readonly type="text" class="input_text2" size="30" /></td>
                        </tr>
                        <tr>
                            <td width="15%" class="title1">金额 ：</td>
                            <td class="left"><input name="expenseAccountForm.money" type="text" class="input_text2" size="30" /></td>
                        </tr>
                        <tr>
                            <td width="15%" class="title1">描述：</td>
                            <td class="left">
                                <textarea cols="33" rows="5" name="expenseAccountForm.dscp"></textarea>
                            </td>
                        </tr>
                        </tbody>
                    </table>
