                ...
                <div class="the_content">
                    ...
                    <table class="tableHue2" width="100%" border="1" bordercolor="#dddddd" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td class="left"><input name="vacationForm.startDate" id="startDate" type="date" class="input_text2" size="30" /></td>
                        </tr>
                        <tr>
                            <td width="15%" class="title1">结束日期：</td>
                            <td class="left"><input name="vacationForm.endDate" id="endDate" type="date" class="input_text2" size="30" /></td>
                        </tr>
                        <tr>
